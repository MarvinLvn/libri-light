...
UNIQUE_GENRE_FOLDING = {'Religion': ['American Standard Version', 'Religious Fiction', 'Christianity - Biographies', 'Christian Fiction', 'Weymouth New Testament', 'Other religions', 'World English Bible', 'Christianity - Commentary', 'Atheism & Agnosticism', 'Bibles', 'Religion', 'Christianity - Other'],
                        ...
                        'Non fiction': ['Biography', 'Biography & Autobiography', 'Middle Ages/Middle History', 'Letters', 'Historical', 'Exploration', "Children's Non-fiction", 'Short non-fiction', 'History', 'Memoirs', 'Non fiction'],
